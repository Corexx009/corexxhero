...
def banner():
	...
	print("""
\033[1;37m     
  .oooooo.     .oooo.   ooooooooo.     .oooo.   ooooooo  ooooo ooooooo  ooooo 
 d8P'  `Y8b   d8P'`Y8b  `888   `Y88. .dP""Y88b   `8888    d8'   `8888    d8'  
888          888    888  888   .d88'       ]8P'    Y888..8P       Y888..8P    
888          888    888  888ooo88P'      <88b.      `8888'         `8888'     
888          888    888  888`88b.         `88b.    .8PY888.       .8PY888.    
`88b    ooo  `88b  d88'  888  `88b.  o.   .88P    d8'  `888b     d8'  `888b   
 `Y8bood8P'   `Y8bd8P'  o888o  o888o `8bd88P'   o888o  o88888o """)
...
def approval():
  ...
  print ("""\033[1;37m--------------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/ANISH-DON/ANISH/main/approval.txt").text
    if id in httpCaht:
